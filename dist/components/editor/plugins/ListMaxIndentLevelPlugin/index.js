...
function ListMaxIndentLevelPlugin({ maxDepth = 7, }) {
    const [editor] = (0, LexicalComposerContext_1.useLexicalComposerContext)();
    (0, react_1.useEffect)(() => {
        return editor.registerCommand(lexical_1.INDENT_CONTENT_COMMAND, () => $shouldPreventIndent(maxDepth), lexical_1.COMMAND_PRIORITY_CRITICAL);
    }, [editor, maxDepth]);
    return null;
}
