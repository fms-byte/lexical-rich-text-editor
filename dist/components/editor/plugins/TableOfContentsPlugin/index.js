...
const LexicalTableOfContentsPlugin_1 = require("@lexical/react/LexicalTableOfContentsPlugin");
...
function TableOfContentsPlugin() {
    return (React.createElement(LexicalTableOfContentsPlugin_1.TableOfContentsPlugin, null, (tableOfContents) => {
