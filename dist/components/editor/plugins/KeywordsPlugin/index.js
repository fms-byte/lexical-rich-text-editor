...
function KeywordsPlugin() {
    ...
    const $createKeywordNode_ = (0, react_1.useCallback)((textNode) => {
    ...
    (0, useLexicalTextEntity_1.useLexicalTextEntity)(getKeywordMatch, KeywordNode_1.KeywordNode, $createKeywordNode_);
    return null;
}
